...
This is appriate for single-page applications (SPA) where you want to manage navigation and serve all the pages client-side.

Here's a full application with two pages.
We'll go through the differences between it and a document application in the next sections.
...
You can now try out the routes:

* http://localhost:3000/
* http://localhost:3000/about
* http://localhost:3000/asdf

TODO: explain differences from document

TODO: link to nested tea page
