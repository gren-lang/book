...
Anything that can be trivially mapped to JSON can be used as flags. Since the 0.6.4 version of the Gren compiler,
you can also pass in [DataView](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) as flags. This will be received as `Bytes` on the Gren end.
